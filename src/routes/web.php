...
Route::middleware('auth:web')->group(function () {
    ...
    Route::get('/news4/{news}/edit', [Controllers\NewsController::class, 'edit4'])->name('news4.edit');
    Route::get('/news5/{news}/edit', [Controllers\NewsController::class, 'edit5'])->name('news5.edit');
    Route::get('/news6/{news}/edit', [Controllers\NewsController::class, 'edit6'])->name('news6.edit');
    Route::post('/news/store', [Controllers\NewsController::class, 'store1']);
    Route::post('/news1/store', [Controllers\NewsController::class, 'store1'])->middleware(\Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class);
    Route::post('/news2/store', [Controllers\NewsController::class, 'store2']);
    Route::post('/news3/store', [Controllers\NewsController::class, 'store3']);
    Route::post('/news4/store', [Controllers\NewsController::class, 'store4']);
    Route::post('/news5/store', [Controllers\NewsController::class, 'store5']);
    Route::post('/news6/store', [Controllers\NewsController::class, 'store5']);
